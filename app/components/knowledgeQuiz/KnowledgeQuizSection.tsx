...
export default function KnowledgeQuizSection() {
  ...
  const handleCreated = (question: KqQuestion) => {
  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 max-w-3xl text-sm text-gray-400">
            Standalone knowledge quiz questions, newest first. Each belongs to a
            sport and carries a server-generated id like{" "}
            <span className="font-mono text-gray-300">KQ-F-12</span>. Editing,
            deleting and quiz sets are not available yet.
          </p>
        </div>
      ...
      {notice && (
        <div className="mb-6 flex items-start gap-2 rounded-lg border border-emerald-700 bg-emerald-950/40 px-4 py-3 text-sm text-emerald-300">
      ...
      {error && (
        <div className="mb-6 flex items-start gap-2 rounded-lg border border-red-700 bg-red-950/40 px-4 py-3 text-sm text-red-300">
