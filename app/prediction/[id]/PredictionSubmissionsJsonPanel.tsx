...
type PredictionSubmissionsJsonPanelProps = {
  embedded?: boolean;
};

export default function PredictionSubmissionsJsonPanel({
  embedded,
}: PredictionSubmissionsJsonPanelProps = {}) {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-black dark:text-white mb-4">
        Prediction submitted users (raw JSON)
      </h2>
      {fetchError && (
