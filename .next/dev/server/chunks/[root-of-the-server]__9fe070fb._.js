...
"[project]/app/constants/prediction-status.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/predictions/[id]/update-status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$constants$2f$prediction$2d$status$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/constants/prediction-status.ts [app-route] (ecmascript)");
;
;
;
async function PUT(request, context) {
    try {
        ...
        const hasOnlyPredictionStatusKey = body && typeof body === "object" && Object.keys(body).length === 1 && Object.prototype.hasOwnProperty.call(body, "predictionStatus");
        if (!hasOnlyPredictionStatusKey || typeof body.predictionStatus !== "string") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: "Only predictionStatus is allowed in request body and it must be a string"
            }, {
                status: 400
            });
        }
        const predictionStatus = body.predictionStatus.trim().toUpperCase();
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$constants$2f$prediction$2d$status$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PREDICTION_STATUS_VALUES"].includes(predictionStatus)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: `Invalid predictionStatus. Allowed values: ${__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$constants$2f$prediction$2d$status$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PREDICTION_STATUS_VALUES"].join(", ")}`
            }, {
                status: 400
            });
        }
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])(`/prediction/updatePredictionStatus/${id}`, {
            method: "PUT",
        ...
        if (!response.ok) {
            ...
            const errorMessage = typeof errorData.error === "string" ? errorData.error : typeof errorData.message === "string" ? errorData.message : typeof errorData.msg === "string" ? errorData.msg : `Failed to update prediction status (Status: ${response.status})`;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(prediction, {
            status: 200
        });
    } catch (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            message: error instanceof Error ? error.message : "Failed to update prediction status"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9fe070fb._.js.map