...
"[project]/app/api/tournament/teams/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])(`/tournament/teams/${tournament}`);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(teams, {
            status: 200
        });
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const { name, abbreviation, tournamentType, description, primaryColor, secondaryColor, textColor, displayName } = body;
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])("/tournament/create-team", {
            method: "POST",
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(team, {
            status: 201
        });
    } catch (error) {
        // If error is a NextResponse (from authenticatedFetch), return it
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5fe71fd3._.js.map