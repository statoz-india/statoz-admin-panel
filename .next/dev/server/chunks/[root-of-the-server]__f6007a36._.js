...
async function PUT(request, context) {
    try {
        ...
        if (Object.keys(payload).length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: "At least one field must be provided: tournamentName, primaryColor, secondaryColor, textColor"
            }, {
                status: 400
            });
        }
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])(`/tournament/update-tournament/${tournamentId}`, {
            method: "PUT",
        ...
        if (!response.ok) {
            ...
            try {
                ...
                errorData = {
                    message: errorText || "Failed to update tournament"
                };
            }
            const nestedError = errorData.data && typeof errorData.data === "object" && errorData.data !== null && "error" in errorData.data && typeof errorData.data.error === "string" ? errorData.data.error : undefined;
            const errorMessage = nestedError ?? (typeof errorData.error === "string" ? errorData.error : typeof errorData.message === "string" ? errorData.message : typeof errorData.msg === "string" ? errorData.msg : `Failed to update tournament (Status: ${response.status})`);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        const tournament = backendResponse && "data" in backendResponse && backendResponse.data ? backendResponse.data : backendResponse;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(tournament, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6007a36._.js.map