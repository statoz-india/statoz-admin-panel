...
async function tryRefreshAccessToken() {
    ...
    if (data.data.refreshToken) {
        cookieStore.set(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$const$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["REFRESH_TOKEN"], data.data.refreshToken, {
            ...COOKIE_OPTIONS,
            maxAge: 60 * 60 * 24 * 7
        });
    }
...
"[project]/app/api/quiz/[id]/user-response.dart/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])(`/quiz/getSubmission/${id}`);
        ...
        const parsed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleExternalApiResponse"])(response);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(parsed.data, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d3c393b._.js.map