...
"[project]/app/api/tournament/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])("/tournament/tournament-types");
...
async function POST(request) {
    try {
        ...
        const { tournament, tournamentName, tournamentYear, primaryColor, secondaryColor, textColor } = body;
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])("/tournament/create-tournament", {
            method: "POST",
        ...
        if (!response.ok) {
            ...
            try {
                ...
                errorData = {
                    message: errorText || "Failed to create tournament"
                };
            }
            const errorMessage = typeof errorData.error === "string" ? errorData.error : typeof errorData.message === "string" ? errorData.message : typeof errorData.msg === "string" ? errorData.msg : `Failed to create tournament (Status: ${response.status})`;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11ccae16._.js.map