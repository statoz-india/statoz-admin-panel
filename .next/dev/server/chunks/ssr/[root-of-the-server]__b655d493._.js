...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$loading$2d$indicators$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-loading-indicators/esm/index.js [app-ssr] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module './event-appearance'");
...
function EventsSection() {
    ...
    const fetchEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            ...
            const response = await res.json();
            if (!res.ok) {
                const message = typeof response?.message === "string" && response.message || typeof response?.error === "string" && response.error || "Failed to load events";
                setError(message);
                setEvents([]);
                return;
            }
    ...
    const handleEventNavigate = (ev)=>{
        ...
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        router.push(`/event/${ev._id}?from=events`, {
            scroll: false
        });
    };
    if (loading) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b655d493._.js.map