...
function LeaderboardSection() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchLeaderboard = async ()=>{
            try {
                setLoading(true);
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLeaderboard"])();
                ...
                if (Array.isArray(response.data)) {
                    ...
                    if (Array.isArray(dataObj.users)) {
                        leaderboardData = dataObj.users;
                    } else if (Array.isArray(dataObj.leaderboard)) {
                        leaderboardData = dataObj.leaderboard;
                    } else if (Array.isArray(dataObj.data)) {
                        leaderboardData = dataObj.data;
                    }
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6b084b0e._.js.map