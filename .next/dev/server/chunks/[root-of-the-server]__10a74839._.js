...
"[project]/app/constants/event-status.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/events/[id]/update-status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$constants$2f$event$2d$status$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/constants/event-status.ts [app-route] (ecmascript)");
;
;
;
async function PUT(request, context) {
    try {
        ...
        const hasOnlyEventStatusKey = body && typeof body === "object" && Object.keys(body).length === 1 && Object.prototype.hasOwnProperty.call(body, "eventStatus");
        if (!hasOnlyEventStatusKey || typeof body.eventStatus !== "string") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: "Only eventStatus is allowed in request body and it must be a string"
            }, {
                status: 400
            });
        }
        const eventStatus = body.eventStatus.trim().toUpperCase();
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$constants$2f$event$2d$status$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EVENT_STATUS_VALUES"].includes(eventStatus)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: `Invalid eventStatus. Allowed values: ${__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$constants$2f$event$2d$status$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EVENT_STATUS_VALUES"].join(", ")}`
            }, {
                status: 400
            });
        }
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])(`/events/updateEventPredictionStatus/${encodeURIComponent(id)}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!response.ok) {
            ...
            try {
                ...
                errorData = {
                    message: errorText || "Failed to update event status"
                };
            }
            const errorMessage = typeof errorData.error === "string" ? errorData.error : typeof errorData.message === "string" ? errorData.message : `Failed to update event status (Status: ${response.status})`;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10a74839._.js.map