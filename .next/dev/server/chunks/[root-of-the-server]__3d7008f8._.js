...
"[project]/app/api/users/[id]/playedPredictionsForAdmin/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, context) {
    try {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])(`/user/playedPredictionsForAdmin/${id}`);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(data.data, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3d7008f8._.js.map