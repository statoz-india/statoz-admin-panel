...
"[project]/app/api/users/[id]/gift-coins/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, context) {
    try {
        ...
        if (typeof giftedcoins !== "number" || !Number.isFinite(giftedcoins) || giftedcoins <= 0 || !Number.isInteger(giftedcoins)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])(`/user/giftCoinsToUser/${userId}`, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!response.ok) {
            ...
            try {
                ...
                errorData = {
                    message: errorText || "Failed to gift coins"
                };
            }
            const errorMessage = typeof errorData.error === "string" ? errorData.error : typeof errorData.message === "string" ? errorData.message : `Failed to gift coins (Status: ${response.status})`;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(backendResponse.data ?? backendResponse, {
            status: 200,
            message: typeof backendResponse.message === "string" ? backendResponse.message : "Coins gifted successfully"
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__27b505ac._.js.map