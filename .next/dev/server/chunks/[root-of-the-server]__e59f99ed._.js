...
;
;
function unwrapEventsList(body) {
    return Array.isArray(body) ? body : body.data;
}
async function GET() {
    try {
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])("/events");
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(unwrapEventsList(data), {
            status: 200
        });
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const { tournament, eventName, eventDescription, eventImage, eventDescriptionImage, haveThreeOptions, yesPlaceholder, noPlaceholder, maybePlaceholder, entryStartTime, entryCloseTime } = body;
        const apiPayload = {
            tournament,
            eventName,
            eventDescription,
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])("/events/createEvent", {
            method: "POST",
        ...
        if (!response.ok) {
            ...
            try {
                ...
                errorData = {
                    message: errorText || "Failed to create event"
                };
            }
            const errorMessage = typeof errorData.error === "string" ? errorData.error : typeof errorData.message === "string" ? errorData.message : typeof errorData.msg === "string" ? errorData.msg : `Failed to create event (Status: ${response.status})`;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e59f99ed._.js.map