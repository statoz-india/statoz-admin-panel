...
"[project]/app/api/futures/[id]/edit-choices/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseBackendError(errorData) {
    ...
    return nestedError ?? (typeof errorData.error === "string" ? errorData.error : typeof errorData.message === "string" ? errorData.message : "Failed to update future choices");
}
function isValidChoiceBody(item) {
    return !!item && typeof item === "object" && typeof item._id === "string" && item._id.trim().length > 0;
}
async function PUT(request, context) {
    try {
        ...
        if (!choices.every(isValidChoiceBody)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: "Each choice must include a valid _id"
            }, {
                status: 400
            });
        }
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])(`/futures/editFutureChoices/${encodeURIComponent(id)}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!response.ok) {
            ...
            try {
                ...
                errorData = {
                    message: errorText || "Failed to update future choices"
                };
            }
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: parseBackendError(errorData)
            }, {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            message: error instanceof Error ? error.message : "Failed to update future choices"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__37538f75._.js.map