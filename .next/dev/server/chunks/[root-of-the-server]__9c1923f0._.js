...
"[project]/app/api/tournament/getAllTournamentAndDetails/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function unwrapTournaments(body) {
    return Array.isArray(body) ? body : body.data;
}
async function GET() {
    try {
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])("/tournament/getAllTournamentAndDetails");
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(unwrapTournaments(data), {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9c1923f0._.js.map