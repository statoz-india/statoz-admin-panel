...
"[project]/app/api/match/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (gameType !== "cricket" && gameType !== "football" && gameType !== "basketball") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: "Please select a valid game type (cricket or football or basketball)"
            }, {
                status: 400
            });
        }
        const apiPayload = {
            ...
            tag: tag ?? "",
            gameType: gameType,
            ...matchStartTime != null && matchStartTime !== "" && {
                matchStartTime
            }
        };
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$utils$2f$api$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatedFetch"])("/match/createMatch", {
            method: "POST",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__729aa2c3._.js.map